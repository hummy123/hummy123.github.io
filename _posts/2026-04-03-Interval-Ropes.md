...
(* deletes last interval *)                                           val r6 = IntervalRope.delete (11, 5, r4)                              val r6Pass =                                                            not (IntervalRope.hasIntervalAtIndex (12, r6) orelse                  IntervalRope.hasIntervalAtIndex (13, r6) orelse                       IntervalRope.hasIntervalAtIndex (14, r6))
```

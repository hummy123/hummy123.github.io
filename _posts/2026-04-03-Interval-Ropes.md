...
![A tree showing circles with numbers an arrows to square nodes that contain text] (https://github.com/hummy123/hummy123.github.io/blob/main/docs/assets/Initial-Rope.png)
